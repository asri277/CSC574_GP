...
<body>
	...
	<h2 align="center" style="color: #fff; font: 20px; padding-top: 10px;">STAFF DATA</h2><br>
	...
	<table border="1" cellspacing="0" width="100%">
		...
		{
			$query = "SELECT * FROM `staff` WHERE `staff_id` LIKE '$keyword';";
			return query($query);
		}
		...
		while($hasil = mysqli_fetch_array($select)){
			...
			<tr style="text-align: center; background-color: rgba(255, 255, 255, .20); color: #FFF;">
				...
				<td>
					<a href="staff_edit_form.php?staff_id=<?php echo $hasil['staff_id'] ?>" style="text-decoration: none; color: #FFD019;">Edit</a> ||
					<a href="delete_staff.php?staff_id=<?php echo $hasil['staff_id'] ?>" style="text-decoration: none; color: #F28B88;">Delete</a>
				</td>
			</tr>
			<?php }}else{ ?>
			<tr>
