...
<body>
	...
	<h2 align="center" style="color: #fff; font: 20px; padding-top: 10px;">MOVIE DATA</h2><br>
	...
	<a href="movie_insert_form.php" style="padding: 0.4% 0.8%;background-color: #6082B6;color: #fff;border-radius: 2px;text-decoration: none;">Add Data</a><br><br><br>
	...
	<table border="1" cellspacing="0" width="100%">
		...
		{
			$query = "SELECT * FROM `movie` WHERE `movie_id` LIKE '$keyword';";
			return query($query);
		}
		...
		while($hasil = mysqli_fetch_array($select)){
			...
			<tr style="text-align: center; background-color: rgba(255, 255, 255, .20); color: #FFF;">
				...
				<td>
					<a href="movie_edit_form.php?movie_id=<?php echo $hasil['movie_id'] ?>" style="text-decoration: none; color: #FFD019;">Edit</a>
